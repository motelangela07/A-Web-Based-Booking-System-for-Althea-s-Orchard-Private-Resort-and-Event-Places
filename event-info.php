...
<link rel="stylesheet" href="your-fonts.css">
    ...
    <link rel="stylesheet" type="text/css" href="css/event-info.css">
...
if (isset($_POST['sent'])){
    ...
    $email = $_POST['email'];
    $ref_no = $_SESSION['ref_no'];
    $sql_event_info = "INSERT INTO event_info VALUES(null,'$ref_no','$fname','$lname','$con','$pcode','$add','$email')";
    if(mysqli_query($conn, $sql_event_info)){ 
    ...
    function myFunction() {
      swal({
        ...
        window.location = "event-confirmation.php";
      });
    }
  </script>';
} else {
  echo '<script>
    function myFunction() {
      swal({
        ...
        window.location = "event-info.php";
      });
    }
  </script>';
}
