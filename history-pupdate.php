            ...
            <div class="table-responsive booking-history-table-responsive">
                <table class="table m-0 booking-history-table">
                    ...
                    <form  method="post" enctype = "multipart/form-data" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
                        ...
                        $ref_id = $_GET['ref_id'];
                        $q = $conn->query("SELECT * FROM `photo_details` WHERE `photo_ref_no` = '$ref_id'");
						$result = $q->fetch_array();
                            ?>
                            <tr>
                            <td>
                            <div class="form-group">
                            <label class="date">Photo Date</label>
                            <input type="date" name="date" class="form-control" required value="<?php echo $result['photo_date']?>">
                            </div>
                           </div>
                            </td>
                            ...
                            <td>
                            <div class="form-group">
                            <label class="time">Photo Time</label>
                            <select name="time" required  class="form-control">
                            <option value="<?php echo $result['photo_time']?>">Selected Time: <?php echo $result['photo_time']?></option>
                           ...
                           <div class="form-group">
                            ...
                            <option value="<?php echo $result['photo_price']?>">Photo Price: <?php echo $result['photo_price']?></option>
                            ...
                            <td>
                            <input type="hidden" name="ref_id"value="<?php echo $result['photo_ref_no']?>">
            ...
            <div class="table-responsive booking-history-table-responsive">
                <table class="table m-0 booking-history-table">
                    ...
                    <tbody>
                        ...
                        <?php
                        // Include your database connection file (connect.php)
                        $q = $conn->query("SELECT * FROM `photo_info` WHERE `photos_ref_no` = '$ref_id'");
						$result = $q->fetch_array();
                            ?>
                            <tr>
                            <td>
                           ...
                           <input type="text" name="fname" class="form-control" required value="<?php echo $result['photos_fname']?>">
                           </div>
                           </div>
                           ...
                           <input type="text" name="lname" class="form-control" required value="<?php echo $result['photos_lname']?>" >
                           </div>
                           </div>
                            </td>
                            ...
                            <input type="text" pattern=".{11}" name="con" class="form-control" value="<?php echo $result['photos_contact']?>" maxlength="11"title="Must 11 numbers only" required>
                            </div>
                            </div>
                           </td>
                           ...
                           <input type="number" name="pcode" class="form-control" required  value="<?php echo $result['photos_postal_code']?>">
                           </div>
                           </div>
                            </td>
                            ...
                            <input type="text" name="add" class="form-control" required value="<?php echo $result['photos_address']?>">
                            </div>
                            </div>
                            </td>
                            ...
                            <input type="email" name="email" class="form-control" required value="<?php echo $result['photos_email']?>">
                            </div>
                            </div>
                            </td>
                         ...
                         $ref_id = $_POST['ref_id'];
                          ...
                          $sql_sched1  = "UPDATE photo_details SET `photo_date`='$date',`photo_time`='$time',
                         `photo_price`='$price' WHERE `photo_ref_no`='$ref_id'";	
                          if (mysqli_query($conn, $sql_sched1)){}
                
                          $sql_sched  = "UPDATE photo_info SET `photos_fname`='$fname',`photos_lname`='$lname'
                          ,`photos_contact`='$con',`photos_postal_code`='$pcode'
                          ,`photos_address`='$add',`photos_email`='$email' WHERE `photos_ref_no`='$ref_id'";	
				         if (mysqli_query($conn, $sql_sched)){
                                    ...
                                    window.location = "history-pupdate.php?ref_id='.$ref_id.'";
                                    });}
                                     </script>';
								}
                             }
