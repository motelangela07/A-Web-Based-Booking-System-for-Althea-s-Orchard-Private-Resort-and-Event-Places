...
<link rel="stylesheet" href="your-fonts.css">
    ...
    <link rel="stylesheet" type="text/css" href="css/photo-confirmation.css">
...
<?php
    $ref_no = $_SESSION['ref_no'];
        $query = $conn->query("SELECT * FROM photo_info WHERE photos_ref_no = '$ref_no'");
		$fetch = $query->fetch_array();    
        //photo  ref_no for photo_details
        $query1 = $conn->query("SELECT * FROM photo_details WHERE photo_ref_no = '$ref_no'");
		$fetch1 = $query1->fetch_array(); 
       //
        $query2 = $conn->query("SELECT * FROM photo_info WHERE photos_ref_no = '$ref_no'");
        $fetch2 = $query2->fetch_array(); 

        $query3 = $conn->query("SELECT * FROM photo_info WHERE photos_ref_no = '$ref_no'");
        $fetch3 = $query3->fetch_array(); 
        $query4 = $conn->query("SELECT * FROM photo_info WHERE photos_ref_no = '$ref_no'");
        ...
        <div class="row justify-content-start">
            <div class="col-12">
                <div id="bg1">
                    ...
                    <h4>Photo Shoot Itinerary</h4>
            <b>Photo Shoot Reference No. :</b>
            <?php echo $ref_no;?> <br>

            <b>Photo Shoot Date:</b> 
            <?php echo $fetch1['photo_date'];?> <br>

            <b>Photo Shoot Time :</b>
            <?php echo $fetch1['photo_time'];?> <br>

            <b>Total Fee :  </b> ₱
            <?php echo $fetch1['photo_price'];?> <br>
            
                    <b> Full Name: </b>
                    <?php echo $fetch2['photos_fname'];  ?> 
                    <?php echo $fetch2['photos_lname'];  ?> <br>
                    <b>Contact : </b>
                    <?php echo $fetch2['photos_contact'];  ?> <br>
                    <b>Address : </b>
                    <?php echo $fetch2['photos_address'];  ?> <br>
                    <b>Email : </b>
                    <?php echo $fetch2['photos_email'];  ?> <br>
