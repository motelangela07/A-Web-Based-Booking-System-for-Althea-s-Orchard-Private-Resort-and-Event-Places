...
<link rel="stylesheet" href="your-fonts.css">
    ...
    <link rel="stylesheet" type="text/css" href="css/photo-info.css">
...
if (isset($_POST['sent'])){
    ...
    $email = $_POST['email'];
    $ref_no = $_SESSION['ref_no'];
    $sql_photo_info = "INSERT INTO photo_info VALUES(null,'$ref_no','$fname','$lname','$con','$pcode','$add','$email')";
    if(mysqli_query($conn, $sql_photo_info)){ 
    ...
    function myFunction() {
      swal({
        ...
        window.location = "photo-confirmation.php";
      });
    }
  </script>';
} else {
