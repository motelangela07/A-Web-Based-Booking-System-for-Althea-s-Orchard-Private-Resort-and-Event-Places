...
<link rel="stylesheet" type="text/css" href="css/book-events.css">
...
?>
  ...
  <input type="text" id="check-in" name="checkin" placeholder="Select a date" onchange="updateCheckoutMin()">
                ...
                if (isset($_POST['sent'])){
                    ...
                    $sql_event_details = "INSERT INTO event_details VALUES(null,'$ref_id_no','$select','$date','$time','$package','3','$u_id')";
                    if(mysqli_query($conn, $sql_event_details)){ 
