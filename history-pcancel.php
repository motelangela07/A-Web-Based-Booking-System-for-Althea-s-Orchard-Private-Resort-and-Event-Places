...
<div class="content" style="margin-top:100px; text-align: center;">
        ...
        <p>Cancel Photo Shoot Bookings.</p>
      ...
      if(isset($_POST['update_status'])){
                $status = $_POST['status'];
                $add_pax = $_POST['add_pax'];
                $ref_id = $_POST['ref_id'];

                $sql_sched  = "UPDATE photo_details SET `status`='$status' WHERE `photo_ref_no`='$ref_id'";	
				if (mysqli_query($conn, $sql_sched)){
                    ...
                    function myFunction() {
                        ...
                        window.location = "history-pcancel.php?ref_id='.$ref_id.'";
                      });}
